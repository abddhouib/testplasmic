...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: 7lPdUjpgheqN/css
...
function PlasmicContactSection__RenderFunc(props: {
  ...
  return (
    <section
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox___2J1XA)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__aurMb)}>
          <PlasmicLink__
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicContactSection__VariantsArgs, ReservedPropsType> &
