...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: nfnMYla_g4K3/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__npI0B)}>
        <div className={classNames(projectcss.all, sty.column__fmPjF)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__deIg)}>
          <div className={classNames(projectcss.all, sty.columns___3IB2)}>
            <div className={classNames(projectcss.all, sty.column___18LiP)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__oQhd)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__mBcaS)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__uZJr)}>
                {renderPlasmicSlot({
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicProjectHeader__VariantsArgs, ReservedPropsType> &
