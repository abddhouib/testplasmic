...
import sty from "./PlasmicProjectRelaunch.module.css"; // plasmic-import: 8YNJima_EDfl/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <section
            className={classNames(projectcss.all, sty.section__hBrzF)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__aKuUj)}
              displayHeight={"700px"}
          ...
          <section
            className={classNames(projectcss.all, sty.section__m5J2W)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__dlFyz)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___21TC2)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___4IAH)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <section
              className={classNames(projectcss.all, sty.section__i77Xe)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__bZfzr)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img___7Igml)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <div className={classNames(projectcss.all, sty.columns__zXda9)}>
                  <div
                    className={classNames(projectcss.all, sty.column__kWrOc)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__emNcu)}
                      displayHeight={
                  ...
                  <div
                    className={classNames(projectcss.all, sty.column__kUeDh)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__a29He)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox__l2Qs6)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <section
              className={classNames(projectcss.all, sty.section__qsaCc)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__h6WYk)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__inFtA)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__rZyaa)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <section
              className={classNames(projectcss.all, sty.section__jXg)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__twfb)}>
                <h2
              ...
              <div className={classNames(projectcss.all, sty.columns__ut4RS)}>
                <div className={classNames(projectcss.all, sty.column__fs0Cj)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__gx5Zt
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column__t52Eu)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__ybFEn
                    )}
