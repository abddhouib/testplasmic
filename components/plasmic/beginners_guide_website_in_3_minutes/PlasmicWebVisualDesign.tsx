...
import sty from "./PlasmicWebVisualDesign.module.css"; // plasmic-import: T9uQfzIEwvUy/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <section
            className={classNames(projectcss.all, sty.section__paOC)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__gEvPx)}
              displayHeight={"700px"}
          ...
          <section
            className={classNames(projectcss.all, sty.section__ijDjS)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__chg6S)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__zaRU)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__eFZsb)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <section
              className={classNames(projectcss.all, sty.section__vpkG2)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__eVjw)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__zYaj7)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <div className={classNames(projectcss.all, sty.columns__mEpB5)}>
                  <div
                    className={classNames(projectcss.all, sty.column__gBOrx)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img___7XnmD)}
                      displayHeight={
                  ...
                  <div
                    className={classNames(projectcss.all, sty.column__uasCt)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__bia60)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox__b9H9)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <section
              className={classNames(projectcss.all, sty.section___1MU6T)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__guPtj)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img___7HnBv)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__muDIp)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <section
              className={classNames(projectcss.all, sty.section__qJF)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox___3BPs3)}>
                <h2
              ...
              <div className={classNames(projectcss.all, sty.columns__msnw4)}>
                <div className={classNames(projectcss.all, sty.column__vlEDv)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__ho9LC
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column__k6QMu)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard___2CTyh
                    )}
